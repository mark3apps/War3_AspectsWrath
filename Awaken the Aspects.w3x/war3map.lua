...
function CreateUnitsForPlayer0()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("H00R"), -24468.2, -4126.0, 102.363, FourCC("H00R"))
    u = BlzCreateUnitWithSkin(p, FourCC("hsor"), -24594.6, -4249.6, 280.083, FourCC("hsor"))
end
...
function CreateBuildingsForPlayer20()
    ...
    gg_unit_hshy_0011 = BlzCreateUnitWithSkin(p, FourCC("hshy"), -18592.0, -7392.0, 180.000, FourCC("hshy"))
...
function CreateUnitsForPlayer23()
    ...
    local t
    local life
    gg_unit_h003_0007 = BlzCreateUnitWithSkin(p, FourCC("h003"), -5568.0, 1856.0, 180.000, FourCC("h003"))
