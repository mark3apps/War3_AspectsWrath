...
bj_nil_SOUND_DURATION = 5.00	---@type real	
...
-- ===========================================================================
---  This function does nil.  WorldEdit should should eventually ignore CommentString triggers during script generation, but until such a time, this function will serve as a stub.
--- 
...
-- ===========================================================================
---  Consider each unit, one at a time, keeping a "current pick".   Once all units are considered, this "current pick" will be the resulting random unit.
---  The chance of picking a given unit over the "current pick" is 1/N, where N is the number of units considered thusfar (including the current consideration).
--- 
---@return nil
...
function WaitTransmissionDuration(soundHandle, timeType, timeVal)
	...
	elseif (soundHandle == nil) then
		...
		TriggerSleepAction(bj_nil_SOUND_DURATION)
...
-- ===========================================================================
---  Display a text message to a Player Group with an accompanying sound, portrait, speech indicator, and all that good stuff.   - Query duration of sound   - Play sound   - Display text message for duration   - Display animating portrait for duration   - Display a speech indicator for the unit   - Ping the minimap
--- 
---@param toForce force
---@param whichUnit unit
---@param unitName string
...
--- ***************************************************************************
-- ===========================================================================
---  Makes many common UI settings changes at once, for use when beginning and ending cinematic sequences.  Note that some affects apply to all players, such as game speed.  This is unavoidable.
...
-- ===========================================================================
---  The first N heroes trained or hired for each player start off with a standard set of items.  This is currently:   - 1x Scroll of Town Portal
--- 
---@param whichUnit unit
---@return nil
...
-- ===========================================================================
---  Starting Units for Human Players   - 1 Town Hall, placed at start location   - 5 Peasants, placed between start location and nearest gold mine
--- 
---@param whichPlayer player
...
-- ===========================================================================
---  Starting Units for Orc Players   - 1 Great Hall, placed at start location   - 5 Peons, placed between start location and nearest gold mine
--- 
---@param whichPlayer player
---@param startLoc location
---@param doHeroes boolean
...
-- ===========================================================================
---  Counts key structures owned by a player and his or her allies, including structures currently upgrading or under construction.
...
function MeleeCheckForLosersAndVictors()
	...
	---  If the game is already over, do nil
...
function InitGenericPlayerSlots()
	...
	elseif (gType == GAME_TYPE_USE_MAP_SETTINGS) then
		---  Do nil; the map-specific script handles this.
