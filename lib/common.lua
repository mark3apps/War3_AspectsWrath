...
---@class  anyWarcraftObject


function __jarray(jToken) end
...
-- constant native string GetTriggeringVariableName takes nil returns string
...
-- constant native GetSelectedUnit takes nil returns unit
...
-- native        SetUnitPointValueByType takes integer unitType, integer newPointValue returns nil
...
--  Music Interface. Note that if music is disabled, these calls do nil
...
--  native BlzSetDestructableSkin                         takes destructable whichDestructable, integer skinId returns nil
...
---@param unitIDString string
---@return integer
function FourCC(unitIDString) end