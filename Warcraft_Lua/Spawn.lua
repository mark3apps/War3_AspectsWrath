function spawnSetup()
    ...
    baseSpawn.addBase("arcane", gg_rct_Left_Arcane, gg_rct_Right_Everything, gg_unit_h003_0015, gg_rct_Right_Arcane, gg_rct_Left_Everything, gg_unit_h003_0007, 3)
    ...
    baseSpawn.addBase("arcaneHero", gg_rct_Arcane_Hero_Left, gg_rct_Right_Everything, gg_unit_hars_0017, gg_rct_Arcane_Hero_Right, gg_rct_Left_Everything, gg_unit_hars_0158, 3)
    baseSpawn.addBase("arcaneTop", gg_rct_Arcane_Left_Top, gg_rct_Right_Everything, gg_unit_hars_0355, gg_rct_Arcane_Right_Top, gg_rct_Left_Everything, gg_unit_hars_0293, 3)
    baseSpawn.addBase("arcaneBottom", gg_rct_Arcane_Left_Bottom, gg_rct_Right_Everything, gg_unit_hars_0292, gg_rct_Arcane_Right_Bottom, gg_rct_Left_Everything, gg_unit_hars_0303, 3)
    ...
    baseSpawn.addBase("furbolg", gg_rct_Furbolg_Left, gg_rct_Right_Everything, gg_unit_n00D_0003, gg_rct_Furbolg_Right, gg_rct_Left_Everything, gg_unit_n00D_0091, 1)
    baseSpawn.addBase("highElves", gg_rct_Left_High_Elves, gg_rct_Right_Everything, gg_unit_nheb_0109, gg_rct_Right_High_Elves, gg_rct_Left_Everything, gg_unit_nheb_0036, 1)
    ...
    baseSpawn.addBase("merc", gg_rct_Camp_Bottom, gg_rct_Right_Everything, gg_unit_n001_0048, gg_rct_Camp_Top, gg_rct_Left_Everything, gg_unit_n001_0049, 3)
    baseSpawn.addBase("mine", gg_rct_Left_Workshop, gg_rct_Right_Everything, gg_unit_h006_0074, gg_rct_Right_Workshop, gg_rct_Left_Everything, gg_unit_h006_0055, 3)
    baseSpawn.addBase("naga", gg_rct_Naga_Left, gg_rct_Right_Everything, gg_unit_nntt_0135, gg_rct_Naga_Right, gg_rct_Left_Everything, gg_unit_nntt_0132, 1)
    ...
    baseSpawn.addBase("nightElves", gg_rct_Left_Tree, gg_rct_Right_Everything, gg_unit_e003_0058, gg_rct_Right_Tree, gg_rct_Left_Everything, gg_unit_e003_0014, 1)
    baseSpawn.addBase("orc", gg_rct_Left_Orc, gg_rct_Right_Everything, gg_unit_o001_0075, gg_rct_Right_Orc, gg_rct_Left_Everything, gg_unit_o001_0078, 1)
    baseSpawn.addBase("shipyard", gg_rct_Left_Shipyard, gg_rct_Right_Everything, gg_unit_eshy_0120, gg_rct_Right_Shipyard, gg_rct_Left_Start_Bottom, gg_unit_eshy_0047, 1)
    baseSpawn.addBase("hshipyard", gg_rct_Human_Shipyard_Left, gg_rct_Right_Everything, gg_unit_hshy_0011, gg_rct_Human_Shipyard_Right, gg_rct_Left_Start_Top, gg_unit_hshy_0212, 3)
    baseSpawn.addBase("town", gg_rct_Left_Forward_Camp, gg_rct_Right_Everything, gg_unit_h00F_0029, gg_rct_Right_Forward, gg_rct_Left_Everything, gg_unit_h00F_0066, 3)
