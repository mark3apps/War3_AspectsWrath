...
function CreateUnitsForPlayer20()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("ncb0"), -16864.0, -6112.0, -12.659, FourCC("ncb0"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n010"), -20576.0, -224.0, -62.363, FourCC("n010"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n010"), -20256.0, -480.0, -57.446, FourCC("n010"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n011"), -20960.0, -544.0, -42.187, FourCC("n011"))
    u = BlzCreateUnitWithSkin(p, FourCC("n016"), -20704.0, -992.0, 9.840, FourCC("n016"))
    u = BlzCreateUnitWithSkin(p, FourCC("n016"), -20192.0, -2848.0, -34.066, FourCC("n016"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n012"), -19360.0, -2720.0, -24.499, FourCC("n012"))
...
function CreateBuildingsForPlayer23()
    ...
    SetUnitState(gg_unit_e003_0014, UNIT_STATE_MANA, 0)
...
function CreateRegions()
    ...
    gg_rct_Right_Everything = Rect(1504.0, -10976.0, 1792.0, 4448.0)
    gg_rct_Left_Everything = Rect(-24960.0, -13792.0, -24640.0, 1728.0)
    gg_rct_Left_Mage_Base = Rect(-23904.0, -12896.0, -23040.0, -9504.0)
    ...
    gg_rct_Left_Start_Middle = Rect(-17056.0, -6848.0, -16800.0, -4640.0)
