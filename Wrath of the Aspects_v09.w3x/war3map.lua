...
function CreateBuildingsForPlayer23()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nnzg"), -9056.0, -5600.0, 270.000, FourCC("nnzg"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("ugrv"), -8704.0, -5184.0, 270.000, FourCC("ugrv"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nnzg"), -8736.0, -4576.0, 270.000, FourCC("nnzg"))
...
function Trig_Footman_at_Max_Mana_Actions()
    SetUnitLifePercentBJ(GetSpellAbilityUnit(), (GetUnitLifePercent(GetSpellAbilityUnit()) + 5.00))
    IssueImmediateOrderBJ(GetSpellAbilityUnit(), "bearform")
    DisplayTextToForce(GetPlayersAll(), "TRIGSTR_4000")
end
