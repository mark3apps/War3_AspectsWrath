...
function CreateBuildingsForPlayer23()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n00M"), -12896.0, 3168.0, 270.000, FourCC("n00M"))
    SetUnitState(u, UNIT_STATE_MANA, 150)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("ncnt"), -6880.0, -5664.0, 270.000, FourCC("ncnt"))
...
function CreateRegions()
    ...
    gg_rct_Left_Start_Top = Rect(-20064.0, -3552.0, -19584.0, 4256.0)
