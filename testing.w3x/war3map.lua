...
function cine.mapStart()
	try(function()
		...
		BlzFrameSetTexture(imageTest, "UI\\ResourceBar_combined.dds", 0, true)
		BlzFrameSetAbsPoint(imageTest, FRAMEPOINT_TOPLEFT, x + 0.046, y + 0.255)
		BlzFrameSetAbsPoint(imageTest, FRAMEPOINT_BOTTOMRIGHT, x + 0.17, y + 0.126)
		--BlzFrameSetSize(imageTest, 0.2, 0.2)
		...
		BlzFrameSetAbsPoint(frame.resource.goldText, FRAMEPOINT_TOPLEFT, x + 0.084, y + 0.211)
...
function CreateUnitsForPlayer0()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("Hpal"), -102.1, 141.8, 344.432, FourCC("Hpal"))
end
