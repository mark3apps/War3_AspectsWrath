...
function CreateBuildingsForPlayer20()
    ...
    SetUnitState(gg_unit_nheb_0109, UNIT_STATE_MANA, 0)
...
function CreateBuildingsForPlayer23()
    ...
    SetUnitState(gg_unit_nheb_0036, UNIT_STATE_MANA, 0)
...
function CreateUnitsForPlayer23()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("h007"), -8681.0, -1714.5, 283.396, FourCC("h007"))
...
function Trig_Upgrade_to_Fel_Orc_Actions()
    ...
    ReplaceUnitBJ(GetKillingUnitBJ(), FourCC("n00W"), bj_UNIT_STATE_METHOD_RELATIVE)
    SetUnitUserData(GetLastReplacedUnitBJ(), udg_TEMP_Int)
    udg_TEMP_Unit = GetLastReplacedUnitBJ()
    ConditionalTriggerExecute(gg_trg_FUNC_Move_Creeps)
end
