...
function CreateBuildingsForPlayer20()
    ...
    SetUnitState(gg_unit_n00B_0364, UNIT_STATE_MANA, 0)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("ncb3"), -19808.0, -5344.0, 270.000, FourCC("ncb3"))
    u = BlzCreateUnitWithSkin(p, FourCC("ncb3"), -19808.0, -5536.0, 270.000, FourCC("ncb3"))
    u = BlzCreateUnitWithSkin(p, FourCC("ncb3"), -19808.0, -5728.0, 270.000, FourCC("ncb3"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("negt"), -21248.0, -4864.0, 270.000, FourCC("negt"))
...
function CreateUnitsForPlayer20()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nfv4"), -21600.0, -3616.0, -42.942, FourCC("nfv4"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nfv4"), -21760.0, -5376.0, 0.774, FourCC("nfv4"))
