...
function CreateBuildingsForPlayer20()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("ncb5"), -20768.0, -7200.0, 270.000, FourCC("ncb5"))
    u = BlzCreateUnitWithSkin(p, FourCC("hgtw"), -22144.0, -3520.0, 270.000, FourCC("hgtw"))
    u = BlzCreateUnitWithSkin(p, FourCC("ncb5"), -20768.0, -7392.0, 270.000, FourCC("ncb5"))
    ...
    gg_unit_n001_0048 = BlzCreateUnitWithSkin(p, FourCC("n001"), -15296.0, -7232.0, 270.000, FourCC("n001"))
    ...
    gg_unit_h006_0074 = BlzCreateUnitWithSkin(p, FourCC("h006"), -16192.0, -11776.0, 270.000, FourCC("h006"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("hbla"), -19840.0, -6464.0, 270.000, FourCC("hbla"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n00M"), -14880.0, -6560.0, 270.000, FourCC("n00M"))
...
function CreateBuildingsForPlayer23()
    ...
    gg_unit_n001_0049 = BlzCreateUnitWithSkin(p, FourCC("n001"), -12544.0, -2240.0, 270.000, FourCC("n001"))
