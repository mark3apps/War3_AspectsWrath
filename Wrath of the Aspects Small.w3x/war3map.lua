...
function CreateBuildingsForPlayer20()
    ...
    SetUnitState(gg_unit_e003_0058, UNIT_STATE_MANA, 0)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n012"), -21721.5, -1384.6, -13.919, FourCC("n012"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("ngob"), -24640.0, -960.0, 270.000, FourCC("ngob"))
    SetUnitState(u, UNIT_STATE_MANA, 0)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("e007"), -24736.0, -2720.0, 270.000, FourCC("e007"))
...
function CreateBuildingsForPlayer23()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("ngob"), -4416.0, -8384.0, 270.000, FourCC("ngob"))
    SetUnitState(u, UNIT_STATE_MANA, 0)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("e007"), -4320.0, -6624.0, 270.000, FourCC("e007"))
