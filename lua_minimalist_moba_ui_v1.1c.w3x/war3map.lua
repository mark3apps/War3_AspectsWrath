...
function CreateBuildingsForPlayer0()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("htow"), -384.0, 256.0, 270.000, FourCC("htow"))
end
...
function CreateUnitsForPlayer0()
    ...
    local t
    local life
    gg_unit_Hamg_0001 = BlzCreateUnitWithSkin(p, FourCC("Hamg"), 258.4, -131.1, 270.000, FourCC("Hamg"))
    SetUnitState(gg_unit_Hamg_0001, UNIT_STATE_MANA, 285)
    UnitAddItemToSlotById(gg_unit_Hamg_0001, FourCC("gopr"), 0)
    UnitAddItemToSlotById(gg_unit_Hamg_0001, FourCC("ledg"), 5)
    u = BlzCreateUnitWithSkin(p, FourCC("hkni"), 339.2, -13.8, 270.000, FourCC("hkni"))
    u = BlzCreateUnitWithSkin(p, FourCC("hkni"), 366.8, -113.8, 270.000, FourCC("hkni"))
    u = BlzCreateUnitWithSkin(p, FourCC("H000"), -98.8, -842.0, 270.000, FourCC("H000"))
    u = BlzCreateUnitWithSkin(p, FourCC("H000"), 13.4, -842.7, 270.000, FourCC("H000"))
    u = BlzCreateUnitWithSkin(p, FourCC("H000"), 141.1, -846.6, 270.000, FourCC("H000"))
    u = BlzCreateUnitWithSkin(p, FourCC("H000"), 265.1, -858.1, 270.000, FourCC("H000"))
end
...
function CreateBuildingsForPlayer1()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("obar"), 704.0, -704.0, 270.000, FourCC("obar"))
end
...
function CreateUnitsForPlayer1()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("Ofar"), -185.6, -134.4, 270.000, FourCC("Ofar"))
    u = BlzCreateUnitWithSkin(p, FourCC("orai"), -269.2, -29.0, 270.000, FourCC("orai"))
    u = BlzCreateUnitWithSkin(p, FourCC("orai"), -150.4, 1.0, 270.000, FourCC("orai"))
end
...
function CreateUnitsForPlayer2()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("Udre"), 258.8, -512.7, 270.000, FourCC("Udre"))
    u = BlzCreateUnitWithSkin(p, FourCC("uabo"), 423.7, -568.4, 270.000, FourCC("uabo"))
    u = BlzCreateUnitWithSkin(p, FourCC("uabo"), 341.8, -630.2, 270.000, FourCC("uabo"))
end
...
function CreateBuildingsForPlayer3()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("edos"), 704.0, -256.0, 270.000, FourCC("edos"))
end
...
function CreateUnitsForPlayer3()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("Ewar"), -191.5, -499.8, 270.000, FourCC("Ewar"))
    u = BlzCreateUnitWithSkin(p, FourCC("edot"), -281.1, -559.6, 270.000, FourCC("edot"))
    u = BlzCreateUnitWithSkin(p, FourCC("edoc"), -176.4, -640.2, 270.000, FourCC("edoc"))
end
...
function CreateNeutralPassiveBuildings()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("nfoh"), 512.0, 256.0, 270.000, FourCC("nfoh"))
    u = BlzCreateUnitWithSkin(p, FourCC("nmoo"), 128.0, 256.0, 270.000, FourCC("nmoo"))
    u = BlzCreateUnitWithSkin(p, FourCC("ngme"), -512.0, -256.0, 270.000, FourCC("ngme"))
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), -512.0, -704.0, 270.000, FourCC("ngol"))
...
function Trig_add_xp_Actions()
    AddHeroXPSwapped(25, gg_unit_Hamg_0001, false)
end

function InitTrig_add_xp()
    gg_trg_add_xp = CreateTrigger()
    TriggerRegisterTimerEventPeriodic(gg_trg_add_xp, 1.00)
    TriggerAddAction(gg_trg_add_xp, Trig_add_xp_Actions)
end

function Trig_demo_init_Func007Func004Func001Func001Func001C()
    if (not (ConvertedPlayer(GetForLoopIndexA()) ~= Player(3))) then
        return false
    end
    return true
end

function Trig_demo_init_Func007Func004Func001Func001C()
    if (not (ConvertedPlayer(GetForLoopIndexA()) ~= Player(2))) then
        return false
    end
    return true
end

function Trig_demo_init_Func007Func004Func001C()
    if (not (ConvertedPlayer(GetForLoopIndexA()) ~= Player(1))) then
        return false
    end
    return true
end

function Trig_demo_init_Func007Func004C()
    if (not (ConvertedPlayer(GetForLoopIndexA()) ~= Player(0))) then
        return false
    end
    return true
end
...
function config()
    ...
    DefineStartLocation(0, 256.0, -128.0)
    DefineStartLocation(1, -192.0, -128.0)
    DefineStartLocation(2, 256.0, -512.0)
    DefineStartLocation(3, -192.0, -512.0)
